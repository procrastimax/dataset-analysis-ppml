...
class MnistDataset(AbstractDataset):
    def __init__(self, model_img_shape: Tuple[int, int, int], builds_ds_info: bool = False, batch_size: int = 32, preprocessing_func: Optional[Callable[[float], tf.Tensor]] = None):
        ...
        super().__init__(dataset_name="mnist", dataset_path="data", dataset_img_shape=(28, 28, 1), model_img_shape=model_img_shape, train_val_test_split=(1, 0, 1), batch_size=batch_size,
                         imbalance_ratio=1.5, convert_to_rgb=True, augment_train=True, preprocessing_function=preprocessing_func, shuffle=True, is_tfds_ds=True, builds_ds_info=builds_ds_info)
...
class FashionMnistDataset(AbstractDataset):
    def __init__(self, model_img_shape: Tuple[int, int, int], builds_ds_info: bool = False, batch_size: int = 32, preprocessing_func: Optional[Callable[[float], tf.Tensor]] = None):
        ...
        super().__init__(dataset_name="fashion_mnist", dataset_path="data", dataset_img_shape=(28, 28, 1), model_img_shape=model_img_shape, train_val_test_split=(1, 0, 1),
                         batch_size=batch_size, convert_to_rgb=True, augment_train=True, preprocessing_function=preprocessing_func, shuffle=True, is_tfds_ds=True, builds_ds_info=builds_ds_info)
...
class Cifar10Dataset(AbstractDataset):
    def __init__(self, model_img_shape: Tuple[int, int, int], builds_ds_info: bool = False, batch_size: int = 32, preprocessing_func: Optional[Callable[[float], tf.Tensor]] = None):
        ...
        super().__init__(dataset_name="cifar10", dataset_path="data", dataset_img_shape=(32, 32, 3), model_img_shape=model_img_shape, train_val_test_split=(1, 0, 1),
                         batch_size=batch_size, convert_to_rgb=False, augment_train=True, preprocessing_function=preprocessing_func, shuffle=True, is_tfds_ds=True, builds_ds_info=builds_ds_info)
...
class Covid19RadiographyDataset(AbstractDataset):
    def __init__(self, model_img_shape: Tuple[int, int, int], dataset_path: str, builds_ds_info: bool = False, batch_size: int = 32, preprocessing_func: Optional[Callable[[float], tf.Tensor]] = None):
        ...
        super().__init__(dataset_name="covid19-radiography", dataset_path=dataset_path, dataset_img_shape=(299, 299, 3), model_img_shape=model_img_shape, train_val_test_split=(0.8, 0.05,
                                                                                                                                                                                0.15), batch_size=batch_size, convert_to_rgb=False, augment_train=True, preprocessing_function=preprocessing_func, shuffle=True, is_tfds_ds=False, builds_ds_info=builds_ds_info)
