...
class EMNISTLargeUnbalancedDataset(AbstractDataset):
    ...
    def __init__(self,
        ...
        super().__init__(tfds_name="emnist/byclass",
...
class EMNISTMediumUnbalancedDataset(AbstractDataset):
    ...
    def __init__(self,
                 ...
                 augment_train: bool = True,
                 dataset_path: str = "data"):
        super().__init__(tfds_name="emnist/bymerge",
...
class EMNISTMediumBalancedDataset(AbstractDataset):
    ...
    def __init__(self,
                 ...
                 augment_train: bool = True,
                 dataset_path: str = "data"):
        super().__init__(tfds_name="emnist/balanced",
...
class EMNISTLettersBalancedDataset(AbstractDataset):
    ...
    def __init__(self,
                 ...
                 augment_train: bool = True,
                 dataset_path: str = "data"):
        super().__init__(tfds_name="emnist/letters",
...
class EMNISTDigitsManyBalancedDataset(AbstractDataset):
    ...
    def __init__(self,
                 ...
                 augment_train: bool = True,
                 dataset_path: str = "data"):
        super().__init__(tfds_name="emnist/digits",
...
class EMNISTDigitsNormalBalancedDataset(AbstractDataset):
    ...
    def __init__(self,
                 ...
                 augment_train: bool = True,
                 dataset_path: str = "data"):
        super().__init__(tfds_name="emnist/mnist",
