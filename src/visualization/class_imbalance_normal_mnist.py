...
mnist_1 = MnistDatasetClassImbalance(mnist, imbalance_mode="N", imbalance_ratio=0.3)
...
mnist_2 = MnistDatasetClassImbalance(mnist, imbalance_mode="N", imbalance_ratio=0.6)
